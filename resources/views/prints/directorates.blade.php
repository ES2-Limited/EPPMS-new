...
<head>
    ...
    <title>Directorates Report</title>
    <style>
...
<body>
    <main class="page">
        <div class="actions no-print">
            <a class="button secondary" href="{{ \App\Filament\Resources\DirectorateResource::getUrl('index') }}">Go back</a>
            <button class="button" type="button" onclick="window.print()">Print Report</button>
        </div>

        <header class="header">
            <div>
                <h1>Directorates Report</h1>
            ...
            <tbody>
                @forelse ($directorates as $directorate)
                    <tr>
                        ...
                        <td>{{ $directorate->function ?? '-' }}</td>
                    </tr>
                @empty
                    <tr><td colspan="4">No directorates recorded.</td></tr>
                @endforelse
            </tbody>
        </table>
    </main>
